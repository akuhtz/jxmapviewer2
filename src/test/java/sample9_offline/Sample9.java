...
/**
 * A simple sample application that shows a OSM map of Europe based on an
 * offline ZIP file
 * 
...
public class Sample9 {
	...
	public static void main(String[] args) throws IOException {
		...
		// See https://docs.oracle.com/javase/8/docs/api/java/net/JarURLConnection.html
		// for URL syntax details
		// You can create such a ZIP file by zipping the content of
		// ${HOME}/.jxmapviewer2/tile.openstreetmap.org
		// The ZIP file should contain a list of folders (0, 1, 2, 3 ...) that represent
		// the OSM path structure
