...
public class JXMapKit extends JPanel {
	...
	public JXMapKit() {
		...
		/*
		 * // adapter to move the minimap after the main map has moved MouseInputAdapter
		 * ma = new MouseInputAdapter() { public void mouseReleased(MouseEvent e) {
		...
		miniMap.setOverlayPainter(new Painter<JXMapViewer>() {
			...
			public void paint(Graphics2D g, JXMapViewer map, int width, int height) {
				...
				// Point2D centerpos = map.getTileFactory().geoToPixel(mapCenterPosition,
				// map.getZoom());
