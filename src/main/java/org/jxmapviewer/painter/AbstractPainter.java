 ...
 * may extend. It extends {@link org.jxmapviewer.beans.AbstractBean} as a
 ...
 * more control over whether caching is enabled, or for configuring the graphics
 * state, then it may override the appropriate protected methods to interpose
 * its own behavior.
 * </p>
 * 
 * <p>
...
public abstract class AbstractPainter<T> extends AbstractBean implements Painter<T> {
	 ...
	 * caching is enabled, then it is the responsibility of the developer to
