...
/**
 * ClassName: MSTileSystemUtil <br/>
 * date: 2018年4月27日 下午4:03:00 <br/>
 * 
...
public class BingTileUtil {
	...
	/// degrees.</param>
	public static GeoPosition PixelXYToLatLong(int pixelX, int pixelY, int levelOfDetail) {
	 ...
	 * tileY, out int levelOfDetail) { tileX = tileY = 0; levelOfDetail =
	 * quadKey.Length; for (int i = levelOfDetail; i > 0; i--) { int mask = 1 << (i
	 * - 1); switch (quadKey[levelOfDetail - i]) { case '0': break;
	 * 
